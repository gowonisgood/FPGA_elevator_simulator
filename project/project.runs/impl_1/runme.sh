...
HD_PWD='C:/logic_circuit_experiment/week9_practice/xilinx/project/project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log practice9_2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source practice9_2.tcl -notrace
