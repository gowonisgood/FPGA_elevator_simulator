...
HD_PWD='C:/logic_circuit_experiment/week9_practice/xilinx/project/project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log practice9_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source practice9_2.tcl
